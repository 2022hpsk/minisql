...
#define MappingType std::pair<GenericKey *, Row>
...
public:
  ...
  void SetKeyAt(int index, GenericKey *key, const KeyManager &comparator);
  ...
  // inline size_t GetKeySize() const { return key_size_; }
  // inline void SetKeySize(size_t size) { key_size_ = size; }
